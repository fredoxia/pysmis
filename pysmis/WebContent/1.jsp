...
<body>
<div id="loginDialog" class="easyui-dialog" title="朴与素连锁店管理系统" data-options="iconCls:'icon-status_online',resizable:false,modal:true,draggable:false,closable:false,buttons:[{text:'登陆',handler:function(){ login(); }},{text:'PDA登录',handler:function(){ pdaLogin(); }}]" style="width:330px;height:230px;padding:5px">
