...
$(document).ready(function(){
	...
	$('#dataGrid').datagrid({
		...
		columns : [ [
					...
					{field:'depositCash', width:50,title:'现金 预存金额'},
					{field:'depositCard', width:50,title:'刷卡 预存金额'},
					{field:'depositWechat', width:50,title:'微信 预存金额'},
					{field:'depositAlipay', width:50,title:'支付宝 预存金额'},
