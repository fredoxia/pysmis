...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/conf_files/easyUI/themes/icon.css?v=12.30">
<script type="text/javascript" src="<%=request.getContextPath()%>/conf_files/easyUI/locale/easyui-lang-zh_CN.js?v=12.31"></script>